                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                 ...
                                                 <?php
                                                    ...
                                                    foreach ($arr_products as $product) { //echo print_r($product); die;
                                                    $total_amount = 0;
                                                        $total_amount += str_replace(' ', '', str_replace(',', '.',$product['product_info']['price']));
                                                        $details = get_product_details($product['product_info']['id']);
                                                        //echo '<pre>'; print_r($details); 
                                                        ?>
                                                 <tr>
                                                    
                                                 <td> 
                                                   <img src="<?= base_url('attachments/shop_images/' . $product['product_info']['image']) ?>" onerror="this.onerror=null; this.src='https://houseofstitches.in/attachments/shop_images/spark_logo-06.jpg';" alt="Product" style="width:100px; margin-right:10px;" class="img-responsive">
                                                </td>
                                                ...
                                                <td> 
                                                      <div style=" background-color: #f1f1f1; border-radius: 2px; padding: 2px 5px;">
                                                                         ...
                                                                         $grand_total_tqy += $product['product_quantity']; ?> 
                                                      </div>
                                                  </td>
                                                  <td><?= $product['product_info']['price'].' '.$this->config->item('currency') ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $grand_total_tqy; ?></td>
                                                </tr>
                                             <!--   <td colspan="2">
                                                    <?php
                                                    $arr_products = unserialize($tr['products']);
